#include "sdk_common.h"
  ...
  NRF_LOG_MODULE_REGISTER();
    ...
    #error "Too few BLE peripheral links are supported by the BLE SDH module for the maximal number of BLE transport instances"
  #endif
  ...
  BLE_LINK_CTX_MANAGER_DEF(m_link_ctx_storage, NRF_CLI_BLE_UART_MAX_CLIENTS, sizeof(nrf_cli_ble_uart_internal_t *));
  ...
  //{{{
  ret_code_t nrf_cli_ble_uart_service_init() {
