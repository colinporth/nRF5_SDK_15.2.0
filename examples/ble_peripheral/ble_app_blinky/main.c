...
//}}}
#define ADVERTISING_LED   BSP_BOARD_LED_0 // on when device is advertising
#define CONNECTED_LED     BSP_BOARD_LED_1 // on when device has connected
...
//}}}
//{{{
// Function for handling write events to the LED characteristic.
// p_lbs     Instance of LED Button Service to which the write applies.
// led_state Written/desired state of the LED.
...
//}}}
//{{{
// Function for handling events from the button handler module.
// pin_no        The pin that the event applies to.
// button_action The button action (press/release).
...
static void ble_evt_handler (ble_evt_t const* p_ble_evt, void* p_context) {
  ...
  switch (p_ble_evt->header.evt_id) {
    ...
    case BLE_GATTS_EVT_SYS_ATTR_MISSING:
      NRF_LOG_DEBUG ("GATT Server ATTR_MISSING");
